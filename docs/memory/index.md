...
- `agent-retrieval-fallback-optimization.md`: Two-goal optimization for reducing generic insufficient-context fallbacks, with configured-context retrieval reliability implemented and the public web search capability boundary still open.
